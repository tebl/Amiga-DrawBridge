...
The power cable going to the drive was bought ready-made as a floppy power cable as these are still available on sites such as Aliexpress and similar, cutting off the parts I didn't need. If you find that you need 12v for your floppy drives (as is the case with some 5.25" drives), you may connect the larger 4 pin Molex connector to J4 and power the whole thing from a suitable PSU instead - if you buy a kit for connecting SATA/PATA drives up to a system over USB, you can get a suitable PSU and cables with that.
